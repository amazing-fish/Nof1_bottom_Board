...
(function () {
  ...
  GM_addStyle(`
    ...
    #ab-topbar { display:flex; align-items:center; justify-content:space-between; margin-bottom:4px; padding:1px 0; }
    ...
    #ab-status { display:flex; align-items:center; gap:4px; font-size:10.5px; color:#f0f4ff; letter-spacing:.25px; text-shadow: 0 0 8px rgba(0,0,0,0.32); font-weight:500; }
