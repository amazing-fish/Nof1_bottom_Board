...
(function () {
  ...
  GM_addStyle(`
    ...
    #ab-left { display:flex; align-items:center; gap:8px; opacity:.85; }
    #ab-title { color:#e5e8f1; font-size:10.5px; font-weight:700; letter-spacing:.4px; cursor: pointer; text-transform: uppercase; }
    #ab-status { display:flex; align-items:center; gap:6px; font-size:10px; color:#9ba3b0; letter-spacing:.2px; }
    ...
    .ab-icon {
      ...
      font-weight:700; font-size:10px; letter-spacing:.5px; color:#d2d7e1;
      background: rgba(255,255,255,0.07);
      border: 1px solid rgba(255,255,255,0.12); user-select:none; cursor: pointer;
      transition: background 160ms ease, border-color 160ms ease, transform 160ms ease;
    }
    .ab-icon:hover { background: rgba(255,255,255,0.14); border-color: rgba(255,255,255,0.18); }
